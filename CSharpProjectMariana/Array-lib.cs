...
namespace CSharpProjectMariana
{
    class Array_lib
    {
        public static void body()
        {
            ...
            {
                new double[2,5] {{2.1d,5.3d,7.1d,9.2d,7.5d},{2.8d,5.2d,7.6d,9.9d,7.2d}},
                new double[1,5] {{5.2d,2.5d,6.7d,2.3d,7.8d}},
                new double[2,6] {{1.1d,3.7d,5.6d,9.8d,9.9d,2.3d},{4.4d,0.3d,5.5d,7.2d,1.9d,3.5d}},
                new double[2,5] {{2.2d,3.3d,4.4d,5.5d,6.6d},{2.1d,3.2d,4.3d,5.4d,6.5d}}
            };
